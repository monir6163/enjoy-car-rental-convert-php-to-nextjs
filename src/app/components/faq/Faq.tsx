      ...
      <Container>
        ...
        <div className="pt-2 pb-10">
          ...
          <p className="pt-3 text-base">
            ...
            which contains all the agreed terms and conditions of the lease,
            price, information about the rented vehicle, information about the
            driver and the person or company that pays the rent. By signing the
            contract, the client receives authorization to drive the rented
            vehicle and is responsible for the vehicle for the duration of the
            lease.
          </p>
          <h3 className="text-2xl text-red-700 font-semibold">
            1. What does the car rental agreement contain?
